...
CREATE DATABASE IF NOT EXISTS `santé1` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `santé1`;
...
CREATE TABLE IF NOT EXISTS `RENDEZ_VOUS` (
    ...
    `Notification` TINYINT(1) DEFAULT 0 COMMENT '0 = Non notifié, 1 = Notifié',
...
CREATE TABLE IF NOT EXISTS `PAIEMENT` (
    ...
    `Méthode_paiement` ENUM('espèces', 'carte', 'chèque', 'virement') DEFAULT 'espèces',
...
-- ============================================
-- Table de liaison : CONSULTATION_SERVICES
-- Pour la relation ternaire entre MEDECINS, CONSULTATION et SERVICES
-- ============================================
...
-- ============================================
-- Table : PATIENT_SERVICES (liaison patient-service)
-- Pour l'inscription des patients aux services
-- ============================================
